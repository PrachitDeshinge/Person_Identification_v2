#!/usr/bin/env python3
"""
U²-Net (U-squared-Net) Model Architecture
This file contains the core implementation of the U²-Net model, which is used for
salient object detection and other segmentation tasks. This centralized architecture
can be imported by other modules to avoid code redundancy.

Based on the original paper: https://arxiv.org/abs/2005.09007
"""
...
def _upsample_like(src, tar):
    """Upsample tensor 'src' to have the same spatial size as tensor 'tar'"""
...
class RSU7(nn.Module):
    """Residual U-block with 7 stages."""
...
class RSU6(nn.Module):
    """Residual U-block with 6 stages."""
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
...
class RSU5(nn.Module):
    """Residual U-block with 5 stages."""
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
...
class RSU4(nn.Module):
    """Residual U-block with 4 stages."""
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
...
class RSU4F(nn.Module):
    """Residual U-block with 4 dilated stages."""
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
...
class U2NET(nn.Module):
    ...
    This model returns raw logits. Activation functions (e.g., Sigmoid for binary
    segmentation) should be applied in the application-specific code.
    """
